...
from micronurse_webserver.view.login_view import SESSION_ATTR_IOT_USER, CACHE_KEY_IOT_TOKEN
...
def iot_logout(request: HttpRequest):
    ...
    data = utils.post_check(request, CACHE_KEY_IOT_TOKEN + account.phone_number)
